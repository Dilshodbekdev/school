...
class YearlyDiaryStudentUseCase
    implements UseCase<DataState<List<QuarterlyDiaryModel>>, int> {
  final DiaryStudentRepository _repository;

  YearlyDiaryStudentUseCase(this._repository);

  @override
  Future<DataState<List<QuarterlyDiaryModel>>> call({required int params}) async =>
      await _repository.yearlyDiary();
}
