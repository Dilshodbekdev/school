...
part of 'directional_test_student_api_service.dart';
...
class _DirectionalTestStudentApiService
    implements DirectionalTestStudentApiService {
  ...
  Future<HttpResponse<NewIqTestsStudentModel>> newTests(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/directional-test-enrollment',
  ...
  Future<HttpResponse<GetDirectionalTestStudentModel>> getTest(int id) async {
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/directional-test-enrollment/${id}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<AnswerSimpleTestStudentModel>> answerTest(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/directional-test-answer/${questionId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<dynamic>> submitTest(int id) async {
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'api/test/directional-test-enrollment/${id}/submit',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
