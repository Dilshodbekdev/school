...
class CompletedDirectionalTestStudentPage extends StatefulWidget {
  final int id;
  const CompletedDirectionalTestStudentPage({super.key, required this.id});

  @override
  State<CompletedDirectionalTestStudentPage> createState() => _CompletedDirectionalTestStudentPageState();
}

class _CompletedDirectionalTestStudentPageState extends State<CompletedDirectionalTestStudentPage> {
  late final bloc = context.read<DirectionalTestStudentBloc>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<DirectionalTestStudentBloc, DirectionalTestStudentState>(
