...
class DirectionalTestStudentPage extends StatefulWidget {
  const DirectionalTestStudentPage({super.key});

  @override
  State<DirectionalTestStudentPage> createState() => _DirectionalTestStudentPageState();
}

class _DirectionalTestStudentPageState extends State<DirectionalTestStudentPage> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DirectionalTestStudentBloc, DirectionalTestStudentState>(
            ...
            return Dialog(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(S.of(context).doYouWantFinish,style: CustomTextStyle.h24SB,),
                    const Gap(20),
                    Row(
                      children: [
