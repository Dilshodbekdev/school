...
part of 'iq_test_student_api_service.dart';
...
class _IqTestStudentApiService implements IqTestStudentApiService {
  ...
  Future<HttpResponse<GetSimpleTestStudentModel>> getTest(int id) async {
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/iq-test-enrollment/${id}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<AnswerSimpleTestStudentModel>> answerTest(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/iq-test-answer/${questionId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<dynamic>> submitTest(int id) async {
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'api/test/iq-test-enrollment/${id}/submit',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
