...
class NewIqTestsStudentModel {
  NewIqTestsStudentModel({
      this.currentPage, 
  ...
  NewIqTestsStudentModel.fromJson(dynamic json) {
    ...
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        results?.add(NewIqTestModel.fromJson(v));
      });
    }
  }
  int? currentPage;
...
class NewIqTestModel {
  ...
  NewIqTestModel.fromJson(dynamic json) {
    id = json['id'];
    name = json['name'];
