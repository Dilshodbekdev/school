...
class IqTestStudentRepositoryImpl
    with BaseRepository
    implements IqTestStudentRepository {
  final IqTestStudentApiService _apiService;

  IqTestStudentRepositoryImpl(this._apiService);
