...
class IqTestStudentPage extends StatefulWidget {
  const IqTestStudentPage({super.key});

  @override
  State<IqTestStudentPage> createState() => _IqTestStudentPageState();
}

class _IqTestStudentPageState extends State<IqTestStudentPage> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<IqTestStudentBloc, IqTestStudentState>(
