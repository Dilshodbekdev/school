...
part 'score_test_student_api_service.g.dart';

@RestApi()
abstract class ScoreTestStudentApiService {
  factory ScoreTestStudentApiService(Dio dio, {String baseUrl}) =
      _ScoreTestStudentApiService;

  /// URLS
  static const String _tests = 'api/test/score-test-enrollment';
  static const String _getTest = 'api/test/score-test-enrollment/{id}';
  static const String _answerTest = 'api/test/score-test-answer/{questionId}';
  static const String _submitTest = 'api/test/score-test-enrollment/{id}/submit';
