...
class ScoreTestStudentRepositoryImpl
    with BaseRepository
    implements ScoreTestStudentRepository {
  final ScoreTestStudentApiService _apiService;

  ScoreTestStudentRepositoryImpl(this._apiService);
