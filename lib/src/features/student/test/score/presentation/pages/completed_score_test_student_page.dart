...
class CompletedScoreTestStudentPage extends StatefulWidget {
  final int id;
  const CompletedScoreTestStudentPage({super.key, required this.id});

  @override
  State<CompletedScoreTestStudentPage> createState() => _CompletedScoreTestStudentPageState();
}

class _CompletedScoreTestStudentPageState extends State<CompletedScoreTestStudentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<ScoreTestStudentBloc, ScoreTestStudentState>(
