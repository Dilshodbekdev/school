...
class NewIqTestItem extends StatefulWidget {
  final NewIqTestModel model;
  ...
  @override
  State<NewIqTestItem> createState() => _NewIqTestItemState();
}

class _NewIqTestItemState extends State<NewIqTestItem>
