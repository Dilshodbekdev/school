...
part of 'simple_test_student_api_service.dart';
...
class _SimpleTestStudentApiService implements SimpleTestStudentApiService {
  ...
  Future<HttpResponse<NewSimpleTestsStudentModel>> newTests(
    ...
    final _options =
        _setStreamType<HttpResponse<NewSimpleTestsStudentModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              'api/test/simple-test-enrollment',
    ...
    late NewSimpleTestsStudentModel _value;
    try {
      _value = NewSimpleTestsStudentModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<HttpResponse<GetSimpleTestStudentModel>> getTest(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/simple-test-enrollment/${id}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<AnswerSimpleTestStudentModel>> answerTest(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/simple-test-answer/${questionId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<dynamic>> submitTest(int id) async {
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'api/test/simple-test-enrollment/${id}/submit',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
