...
class SimpleTestStudentRepositoryImpl
    with BaseRepository
    implements SimpleTestStudentRepository {
  final SimpleTestStudentApiService _apiService;

  SimpleTestStudentRepositoryImpl(this._apiService);
  ...
  @override
  Future<DataState<NewSimpleTestsStudentModel>> newTests(
          PagingBody body) async =>
      await handleResponse(
  ...
  @override
  Future<DataState<GetSimpleTestStudentModel>> getTest(int id) async =>
