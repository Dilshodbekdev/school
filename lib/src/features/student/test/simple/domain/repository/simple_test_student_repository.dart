...
abstract class SimpleTestStudentRepository {
  Future<DataState<NewSimpleTestsStudentModel>> newTests(PagingBody body);
  ...
  Future<DataState<GetSimpleTestStudentModel>> getTest(
    int id,
  );
