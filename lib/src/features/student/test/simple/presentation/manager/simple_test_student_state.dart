...
class SimpleTestStudentState {
  final List<NewSimpleTestModel> newSimpleTests;
  ...
  final GetSimpleTestStudentModel? getSimpleTestStudentModel;
  ...
  SimpleTestStudentState copyWith({
    List<NewSimpleTestModel>? newSimpleTests,
    ...
    GetSimpleTestStudentModel? getSimpleTestStudentModel,
