...
class CompletedSimpleTestStudentPage extends StatefulWidget {
  final int id;
  const CompletedSimpleTestStudentPage({super.key, required this.id});

  @override
  State<CompletedSimpleTestStudentPage> createState() => _CompletedSimpleTestStudentPageState();
}

class _CompletedSimpleTestStudentPageState extends State<CompletedSimpleTestStudentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<SimpleTestStudentBloc, SimpleTestStudentState>(
