...
class SimpleTestStudentPage extends StatefulWidget {
  const SimpleTestStudentPage({super.key});

  @override
  State<SimpleTestStudentPage> createState() => _SimpleTestStudentPageState();
}

class _SimpleTestStudentPageState extends State<SimpleTestStudentPage> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SimpleTestStudentBloc, SimpleTestStudentState>(
