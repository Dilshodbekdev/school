...
class NewSimpleTestItem extends StatefulWidget {
  final NewSimpleTestModel model;
  final VoidCallback onClick;

  const NewSimpleTestItem({
    super.key,
    required this.model,
  ...
  @override
  State<NewSimpleTestItem> createState() => _NewSimpleTestItemState();
}

class _NewSimpleTestItemState extends State<NewSimpleTestItem>
