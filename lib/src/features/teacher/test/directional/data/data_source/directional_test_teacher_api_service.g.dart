...
part of 'directional_test_teacher_api_service.dart';
...
class _DirectionalTestTeacherApiService
    implements DirectionalTestTeacherApiService {
  ...
  Future<HttpResponse<ActiveIqTestsTeacherModel>> activeTests(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/directional-test?status=1',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<ActiveIqTestsTeacherModel>> completedTests(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/directional-test?status=2',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<ActiveIqTestsTeacherModel>> templateTests(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'api/test/directional-test?status=3',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<List<GetStudentsSimpleTestTeacherModel>>>
    ...
    final _options =
      ...
      extra: _extra,
                ...
                .compose(
                  _dio.options,
                  'api/test/directional-test/${id}/students',
                  queryParameters: queryParameters,
                  data: _data,
                )
                .copyWith(
  ...
  Future<HttpResponse<StudentResultsSimpleTestTeacherModel>>
    ...
    final _options =
      ...
      extra: _extra,
                ...
                .compose(
                  _dio.options,
                  'api/test/directional-test/${id}/student-results',
                  queryParameters: queryParameters,
                  data: _data,
                )
                .copyWith(
