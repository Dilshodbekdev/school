...
class DirectionalTestsTeacherPage extends StatefulWidget {
  const DirectionalTestsTeacherPage({super.key});

  @override
  State<DirectionalTestsTeacherPage> createState() => _DirectionalTestsTeacherPageState();
}

class _DirectionalTestsTeacherPageState extends State<DirectionalTestsTeacherPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<DirectionalTestTeacherBloc, DirectionalTestTeacherState>(
                              ...
                              itemBuilder: (context, index) => index == state.activeTests.length
                                  ...
                                  : ActiveIqTestItem(
                                      ...
                                      onClick: () {
                                        ...
                                        context.pushNamed(AppRoutes.directionalTestDetailsTeacher.name);
                                      },
                                    ),
                            ),
                          )
