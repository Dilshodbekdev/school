...
class IqTestTeacherRepositoryImpl
    with BaseRepository
    implements IqTestTeacherRepository {
  final IqTestTeacherApiService _apiService;

  IqTestTeacherRepositoryImpl(this._apiService);
