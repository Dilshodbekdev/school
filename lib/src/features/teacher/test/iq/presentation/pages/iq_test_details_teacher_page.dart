...
class IqTestDetailsTeacherPage extends StatefulWidget {
  const IqTestDetailsTeacherPage({super.key});

  @override
  State<IqTestDetailsTeacherPage> createState() =>
      _IqTestDetailsTeacherPageState();
}

class _IqTestDetailsTeacherPageState
    extends State<IqTestDetailsTeacherPage> {
                      ...
                      Expanded(
                        child: TextField(
                          controller: TextEditingController(
                              text:
                                  state.getTestTeacherModel?.endedDate ??
                                      '--'),
                          readOnly: true,
                                  ...
                                  (index) => DataRow(
                                    ...
                                    onSelectChanged: (selected) {
                                      if(selected!=true){
                                        ...
                                        context.pushNamed(AppRoutes.studentResultsIqTestTeacher.name);
                                      }
                                    },
                                    cells: <DataCell>[
                                      DataCell(Text(
