...
class ActiveIqTestItem extends StatefulWidget {
  final ActiveIqTestTeacher model;
  final VoidCallback onClick;

  const ActiveIqTestItem({
    super.key,
    required this.model,
  ...
  @override
  State<ActiveIqTestItem> createState() => _ActiveIqTestItemState();
}

class _ActiveIqTestItemState extends State<ActiveIqTestItem>
