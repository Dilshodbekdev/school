...
part of 'score_test_teacher_api_service.dart';
...
class _ScoreTestTeacherApiService implements ScoreTestTeacherApiService {
  ...
  Future<HttpResponse<dynamic>> createTest(
      CreateScoreTestTeacherBody body) async {
  ...
  @override
  Future<HttpResponse<GetScoreTestTeacherModel>> getTest(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<GetScoreTestTeacherModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetScoreTestTeacherModel _value;
    try {
      _value = GetScoreTestTeacherModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<List<GetStudentsSimpleTestTeacherModel>>>
    ...
    final _options =
      ...
      extra: _extra,
                ...
                .compose(
                  _dio.options,
                  'api/test/score-test/${id}/students',
                  queryParameters: queryParameters,
                  data: _data,
                )
                .copyWith(
  ...
  Future<HttpResponse<StudentResultsSimpleTestTeacherModel>>
    ...
    final _options =
      ...
      extra: _extra,
                ...
                .compose(
                  _dio.options,
                  'api/test/score-test/${id}/student-results',
                  queryParameters: queryParameters,
                  data: _data,
                )
                .copyWith(
