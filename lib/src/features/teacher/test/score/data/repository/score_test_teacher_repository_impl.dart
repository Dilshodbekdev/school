...
class ScoreTestTeacherRepositoryImpl
    with BaseRepository
    implements ScoreTestTeacherRepository {
  final ScoreTestTeacherApiService _apiService;

  ScoreTestTeacherRepositoryImpl(this._apiService);
  ...
  @override
  Future<DataState<GetScoreTestTeacherModel>> getTest(int id) async =>
