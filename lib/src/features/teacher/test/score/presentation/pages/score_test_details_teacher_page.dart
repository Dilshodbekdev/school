...
class ScoreTestDetailsTeacherPage extends StatefulWidget {
  const ScoreTestDetailsTeacherPage({super.key});

  @override
  State<ScoreTestDetailsTeacherPage> createState() =>
      _ScoreTestDetailsTeacherPageState();
}

class _ScoreTestDetailsTeacherPageState
    extends State<ScoreTestDetailsTeacherPage> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ScoreTestTeacherBloc, ScoreTestTeacherState>(
                                  ...
                                  (index) => DataRow(
                                    ...
                                    onSelectChanged: (selected) {
                                      if(selected!=true){
                                        ...
                                        context.pushNamed(AppRoutes.studentResultsScoreTestTeacher.name);
                                      }
                                    },
                                    cells: <DataCell>[
                                      DataCell(Text(
